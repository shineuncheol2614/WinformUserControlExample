            ...
            try
            {
                lock (this)
                {
                    ...
                    if (OuterColor != Color.Empty && OuterColor != Color.Transparent && OuterWidth != 0)
                    {
                        ...
                        {
                            g.DrawLine(pen, this.Width - 300, this.Height / 2, this.Width - 20, this.Height / 2); //왼 -> 오
                            g.DrawLine(pen, this.Width / 2, this.Height - 20, this.Width / 2, this.Height - 300); //아 -> 위
                            g.DrawLine(pen, this.Width / 3, this.Height - 30, (this.Width * 2) / 3, this.Height - 290);
                            g.DrawLine(pen, (this.Width * 2) / 3, this.Height - 30, this.Width / 3, this.Height - 290);
                            g.DrawLine(pen, this.Width - 290, this.Height / 3, this.Width - 30, (this.Height * 2) / 3);
                            g.DrawLine(pen, this.Width - 290, (this.Height * 2) / 3, this.Width - 30, this.Height / 3);
                            g.DrawLine(pen, this.Width - 260, (this.Height * 5) / 6, this.Width - 60, this.Height / 6);
                            g.DrawLine(pen, (this.Width * 5)/6, this.Height - 60, this.Width / 6, this.Height - 260);
                            //g.DrawLine(pen, this.Width - 265, this.Height / 5, this.Width - 55, (this.Height * 4) / 5);
                            //g.DrawLine(pen, this.Width - 265, (this.Height * 4) / 5, this.Width - 55, this.Height / 5);
                            //g.DrawLine(pen, this.Width - 295, (this.Height * 3) / 5, this.Width - 25, (this.Height * 2) / 5);
                            //g.DrawLine(pen, this.Width - 295, (this.Height*2) / 5, this.Width - 25, (this.Height*3) / 5);
                            //g.DrawLine(pen, this.Width - 295, (this.Height * 9)/ 10, this.Width - 25, this.Height / 10);
                            //g.DrawLine(pen, this.Width - 295, (this.Height * 7) / 10, this.Width - 25, (this.Height * 3) / 10);
                        }
                        if (OuterWidth >= 0)
                        {
                    ...
                    g.FillPie(
                        new SolidBrush(ProgressColor), ToRectangle(new RectangleF(point, size)),_animatedStartAngle ?? StartAngle,((_animatedValue ?? Value) - Minimum) / (Maximum - Minimum) * 360);
                    ...
                    var textPoint = new PointF(point.X + (size.Width - textSize.Width) / 2, point.Y + (size.Height - textSize.Height) / 2);
